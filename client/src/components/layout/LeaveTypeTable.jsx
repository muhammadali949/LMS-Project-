        ...
        <div style={{ width: '90%', marginLeft: 'auto', marginRight: 'auto' }}>
            <TableContainer component={Paper}>
                <Table className={classes.table} aria-label="simple table">
                    ...
                    <TableHead>
                        <TableRow>
                            <TableCell className={classes.MuiTableRowroot}>LeaveType</TableCell>
                            <TableCell className={classes.MuiTableRowroot}>LeaveNumber</TableCell>
                            ...
                            <TableRow key={row._id}>
                                ...
                                <TableCell>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'start' }}>
                                        <IconButton className={classes.button1} component={Link} to={`/updatepage/${row._id}`}><LaunchIcon /></IconButton>
